...
- Github (https://github.com/Santiplayer18MCMods/TechnoWorld): this is the place where you can find the repository with the mod's source code and assets. You can also create issues to report bugs or make suggestions to improve some aspects of the mod. For more information on how to create an issue, check the ISSUES.md file in the main branch of the repository.
